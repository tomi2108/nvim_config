...
local darkearth_setup = function()
  ...
  vim.api.nvim_set_hl(0, "LineNr", { bg = palette.bg, fg = palette.green })
  vim.api.nvim_set_hl(0, "LineNrAbove", { bg = palette.bg, fg = palette.disabled })
  vim.api.nvim_set_hl(0, "LineNrBelow", { bg = palette.bg, fg = palette.disabled })
  common_setup()
end
