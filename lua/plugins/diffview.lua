      ...
      keymaps = {
        ...
        file_panel = {
          ...
          },
          {
            ...
            { desc = "Select the previous file entry" },
          },
          {
            "n",
            "<cr>",
          ...
          },
          {
            ...
            "cx",
            function()
              local results = vim.system({ "git", "commit", "--amend", "--no-edit" }, { text = true })
                  :wait()
              vim.notify(
                results.stdout,
                vim.log.levels.INFO,
        ...
        file_history_panel = {
          {
            ...
            "j",
            actions.next_entry,
            { desc = "Bring the cursor to the next log entry" },
          },
          { "n", "<down>", actions.select_next_entry, { desc = "Select the next log entry" } },
          {
            ...
            "k",
            actions.prev_entry,
            { desc = "Bring the cursor to the previous log entry." },
          },
